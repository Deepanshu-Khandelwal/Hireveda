...
function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col font-sans relative">
      ...
      {/* Header bar */}
      <header className="w-full py-3.5 md:py-6 px-2.5 sm:px-4 border-b border-slate-900 bg-slate-950/80 backdrop-blur-md sticky top-0 z-40">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4">
          <div className="flex items-center gap-2 sm:gap-2.5">
            <div className="w-7.5 h-7.5 md:w-9 md:h-9 rounded-xl bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 flex items-center justify-center shadow-lg shadow-indigo-500/20 animate-pulse-slow">
              <UserCheck className="w-3.5 h-3.5 md:w-5 md:h-5 text-white" />
            </div>
            <span className="font-bold text-base md:text-xl bg-gradient-to-r from-indigo-300 via-purple-300 to-pink-300 bg-clip-text text-transparent tracking-tight">
              HireVeda
            </span>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-1.5 sm:gap-3">
            ...
            <button
              ...
              className="p-1 sm:p-1.5 bg-slate-900 border border-slate-850 hover:border-slate-700 text-slate-400 hover:text-slate-200 rounded-lg cursor-pointer transition-all active:scale-95 shadow-sm mr-0.5 sm:mr-2 flex items-center justify-center"
            ...
            <button
              ...
              className={`px-2 sm:px-3.5 py-1.5 rounded-lg text-[10px] sm:text-xs font-semibold border transition-all cursor-pointer
                ${viewMode === 'form' 
